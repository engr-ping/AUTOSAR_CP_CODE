...
#define VRM_INPUT_BATTRAY_CHANNEL_NUM  3
#define VRM_INPUT_ADCIF_CHN_BAT0 0
#define VRM_INPUT_ADCIF_CHN_BAT1 1
#define VRM_INPUT_ADCIF_CHN_BAT2 2


/***************************************************************************************************/
/************************** VPUP related  ****************************************************/
/***************************************************************************************************/
#define VRM_PUP_CHANNEL_SIZE           (3U)
...
#define VRM_GET_AD_PUP1                1//ADCIF_GETRAW_V_PUP1_FV
#define VRM_PUP1_R1                    (1000u)
#define VRM_PUP1_R2                    (215u)
#define VRM_PUP1_COV2VOL_PARA          (uint32)(VRM_BASIC_VOLTAGE / 1000u * VRM_PUP1_R2 * VRM_MAX_AD_HEX / 5u * VRM_COMPENSATE_PRECISION / (VRM_PUP1_R1 + VRM_PUP1_R2))

#define VRM_GET_AD_PUP2                2//ADCIF_GETRAW_V_PUP2_FV
#define VRM_PUP2_R1                    (1000u)
#define VRM_PUP2_R2                    (215u)
#define VRM_PUP2_COV2VOL_PARA          (uint32)(VRM_BASIC_VOLTAGE / 1000u * VRM_PUP2_R2 * VRM_MAX_AD_HEX / 5u * VRM_COMPENSATE_PRECISION / (VRM_PUP2_R1 + VRM_PUP2_R2))

#define VRM_GET_AD_PUP3                3//ADCIF_GETRAW_V_PUP3_FV
#define VRM_PUP3_R1                    (1000u)
#define VRM_PUP3_R2                    (215u)
#define VRM_PUP3_COV2VOL_PARA          (uint32)(VRM_BASIC_VOLTAGE / 1000u * VRM_PUP3_R2 * VRM_MAX_AD_HEX / 5u * VRM_COMPENSATE_PRECISION / (VRM_PUP3_R1 + VRM_PUP3_R2))
...
extern const Vrm_StateType_e Vrm_interceptStateType[VRM_PID_SIZE];


extern const Vrm_VoltageChannel_t Vrm_PupChannelCfg[VRM_PUP_CHANNEL_SIZE];
extern const Vrm_VoltageChannel_t Vrm_BattChannelCfg[VRM_INPUT_BATTRAY_CHANNEL_NUM];
