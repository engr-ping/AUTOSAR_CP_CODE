...
#define TLE9210X_PWM_CHANNEL_MAX 12u
#define TLE9210X_HB_CHANNEL_MAX 8u
...
extern const Tle9210x_PwmChnIdType gTle9210x_PwmChnId[TLE9210X_PWM_CHANNEL_MAX];
extern const Tle9210x_HbChnIdType gTle9210x_HbChnId[TLE9210X_HB_CHANNEL_MAX];
#endif
